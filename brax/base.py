...
class Base:
    ...
    def index_set(self, idx: Union[jp.ndarray, Sequence[jp.ndarray]], o: Any) -> Any:
        return tree_map(lambda x, y: x.at[idx].set(y), self, o)

    def index_sum(self, idx: Union[jp.ndarray, Sequence[jp.ndarray]], o: Any) -> Any:
    ...
    def tree_replace(self, params: Dict[str, Optional[jax.typing.ArrayLike]]) -> "Base":
