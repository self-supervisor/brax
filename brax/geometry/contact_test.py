...
from brax import geometry, kinematics, test_utils
...
class SphereTest(absltest.TestCase):
  ...
  """
    ...
    def test_sphere_mesh(self):
        ...
        np.testing.assert_array_almost_equal(c.pos, jp.array([[0.0, 0.0, 0.495]] * 2))
        np.testing.assert_array_almost_equal(c.normal, jp.array([[0, 0.0, 1.0]] * 2), 5)
...
class CapsuleTest(absltest.TestCase):
  ...
  """
    ...
    def test_capsule_hull(self):
        ...
        np.testing.assert_array_almost_equal(c.normal, jp.array([[0, 0.0, 1.0]] * 2), 4)
  ...
  """
    ...
    def test_capsule_edge_hull(self):
        ...
        self.assertEqual(c.pos.shape[0], 2)
        np.testing.assert_array_almost_equal(c.penetration, jp.array([0.006699, -0.3]))
  ...
  """
    ...
    def test_capsule_mesh(self):
        ...
        np.testing.assert_array_almost_equal(c.normal, jp.array([[0, 0.0, 1.0]] * 4), 4)
...
class ConvexTest(absltest.TestCase):
  ...
  """
    ...
    def test_box_box(self):
        ...
        np.testing.assert_array_almost_equal(c.normal, jp.array([[0.0, 0.0, -1.0]] * 4))
