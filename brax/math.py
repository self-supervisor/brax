...
def signed_angle(axis: jp.ndarray, ref_p: jp.ndarray, ref_c: jp.ndarray) -> jp.ndarray:
...
def inv_approximate(a: jp.ndarray, a_inv: jp.ndarray, num_iter: int = 10) -> jp.ndarray:
