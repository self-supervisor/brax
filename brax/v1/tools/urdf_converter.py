...
flags.DEFINE_bool(
    "add_collision_pairs", False, "Adds the collision pairs to the config."
)
...
flags.DEFINE_bool("add_floor", True, "Whether or not to add a floor to the scene.")
...
def main(argv: Sequence[str]) -> None:
    ...
    # Convert the model.
    m = urdf.UrdfConverter(xml_string, add_collision_pairs=FLAGS.add_collision_pairs)
    config = m.config
