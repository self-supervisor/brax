...
from brax.v1.experimental.composer import composer, data_utils
...
class ComposerTest(parameterized.TestCase):
    ...
    def testObservationConcatSplit(self):
        ...
        obs_dict = collections.OrderedDict(
            [(i, jnp.zeros(leading_dims + shape)) for i, shape in enumerate(obs_shapes)]
        )
        # get observer_shapes
