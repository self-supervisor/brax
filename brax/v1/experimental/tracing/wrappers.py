...
class DomainRandomizationWrapper(brax_env.Wrapper):
    ...
    def __init__(
        self,
        env_fn: Callable[..., brax_env.Env],
        custom_tree: Dict[str, Union[List[Pytree], Pytree, brax_env.State, jp.ndarray]],
        custom_tree_in_axes: Tuple[Dict[str, Union[List[Pytree], Pytree, int]]],
    ):
    ...
    def reset(self, rng):
        ...
        return jax.vmap(reset_fn, in_axes=self.custom_tree_in_axes)(self.custom_tree)
