...
def main(cfg: DictConfig):
    ...
    def progress(num_steps, metrics, params):
        ...
        if cfg.use_lff == True:
            ...
            metrics["std_dev_critic"] = std_dev_critic
            metrics["std_dev_actor"] = std_dev_actor
    ...
    dump_metrics_dict_into_csv(metrics=metrics_dump, cfg=cfg, experiment=experiment)
